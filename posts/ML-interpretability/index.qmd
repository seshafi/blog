...
| ![](PDP.png) | 
|:--:| 
| *Partial Decomposition Plots for 3 separate features [@ml_book].* |
...
|---|---|---|---|---|
|     Surrogate Models    |   Simple and interpretable; model-agnostic  | May oversimplify black-box model    |     Scikit-learn, DTExplain    |
